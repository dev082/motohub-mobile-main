...
class SupabaseConfig {
  static const String supabaseUrl = 'https://eilwdavgnuhfyxfqkvrk.supabase.co';
  static const String anonKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVpbHdkYXZnbnVoZnl4ZnFrdnJrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njc3MjUxNjIsImV4cCI6MjA4MzMwMTE2Mn0.kwfOZWgzUEhhQYE3NEPfhYoAQMok0suqVp6FsWBHmu8';
  ...
  static Future<void> initialize() async {
    await Supabase.initialize(
      ...
      authOptions: FlutterAuthClientOptions(
        ...
        // Usa flutter_secure_storage para armazenar tokens JWT de forma segura
        // - Android/iOS: Keychain/Keystore (criptografado)
